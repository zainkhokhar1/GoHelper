...
const Navbar = () => {
    ...
    return (
        ...
        <>
            {/* Client Navbar */}
            {
                true && <div className='flex relative top-0 md:px-8 items-center bg-[#f8f9fa] md:justify-between max-md:justify-between px-3 h-13 text-white shadow-sm shadow-gray-200'>
                    <Image
                        src="/logo.png"
                        width={65}
                        height={65}
                    ...
                    <div className={`transition-all max-md:visible md:hidden duration-500 absolute z-50 flex flex-col items-start inset-0 shadow-sm h-screen w-screen text-black bg-white ${showSlider ? "translate-y-0 block" : "-translate-y-full"}`}>
                        ...
                        </div>
                        {
                            ...
                            true ? <div className='flex relative items-center gap-1 h-14 duration-200 active:bg-black/5 w-full px-2'>
                            ...
                            </div> : <div className='flex items-center gap-2 h-15 duration-200 active:bg-black/5 w-full px-2'>
                                <CircleUser />
            ...
            {/* Worker Navbar */}
            {
                false && <div className='flex relative md:px-8 items-center bg-[#f8f9fa] md:justify-between max-md:justify-between px-3 h-13 text-white shadow-sm shadow-gray-200'>
                    ...
                    <div className={`transition-all max-md:visible md:hidden duration-500 absolute z-50 flex flex-col items-start inset-0 shadow-sm h-screen w-screen text-black bg-white ${showSlider ? "translate-y-0 block" : "-translate-y-full"}`}>
                        ...
                        {
                            // diff on the basis of user login logout
                            false ? <div className='flex relative items-center gap-1 h-14 duration-200 active:bg-black/5 w-full px-2'>
